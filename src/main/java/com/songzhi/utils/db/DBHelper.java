...
public class DBHelper {
	...
	private static final String DATABSE_FILE = Container.RESOURCES_FOLDER + "db.xml"; 
	...
	public static void defaultDatabase() {
		List<DatabaseModel> databases = fetchDatabases();
		if(databases == null || databases.size() == 0) return;
		
		for(DatabaseModel databaseModel : databases) {
